...
class BooksApp extends React.Component {
    state = {
        books1: [
                    ...
                    "industryIdentifiers": [{"type": "ISBN_13", "identifier": "9781593273897"}, {
                        "type": "ISBN_10",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_10", "identifier": "1786462494"}, {
                        "type": "ISBN_13",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_13", "identifier": "9780316206860"}, {
                        "type": "ISBN_10",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_10", "identifier": "159420182X"}, {
                        "type": "ISBN_13",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_13", "identifier": "9781501143786"}, {
                        "type": "ISBN_10",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_13", "identifier": "9783864919640"}, {
                        "type": "ISBN_10",
                    ...
                    "industryIdentifiers": [{"type": "ISBN_10", "identifier": "081473216X"}, {
                        "type": "ISBN_13",
    ...
    render() {
        return (
            <div className="app">
                {/*{this.state.books.filter(book => book.shelf === book.shelf).map( (b) => (b.shelf))}*/}
